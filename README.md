...
- Database: [Sqlite](https://sqlite.org). Data generated by Adam by wearing an [Oura Ring](https://ouraring.com/) from 2018/11/05 to today.  Last heart rate export from [Oura Ring API](https://cloud.ouraring.com/docs/) on 2019/03/04.
